...
// ✅ FinanceNotifications Import එක REMOVE කරන ලදී - Layout එකෙන් එනවා
...
export default function FinanceDashboard() {
  ...
  const kpiData = [
    ...
    { label: 'Total Payouts', value: stats.activeCredits, icon: Wallet, color: 'text-purple-400', bg: 'bg-purple-500/10', trend: 'up', change: 'Monthly' },
    ...
    <div className="space-y-6 text-gray-100 font-sans">
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="relative">
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          {/* ✅ FinanceNotifications REMOVE කරන ලදී - Layout එකෙන් එනවා */}
          <div className="flex items-center gap-3">
            <button 
